...
home_directory = '/Users/nurizaite/Desktop/EEG2TEXT/EEG-To-Text/'
                ...
                if word_data == {}:
                    ...
                    for widx in range(len(word_data)):
                        ...
                        if 'GD_EEG' in data_dict:
                            ...
                            word_obj['et_data'] =  {'FFD': data_dict['FFD'], 'GD': data_dict['GD'], 'TRT': data_dict['TRT'], 'SFD': data_dict['SFD'], 'nFix': data_dict['nFix']}
